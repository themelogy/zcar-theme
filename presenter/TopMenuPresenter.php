<?php namespace Themes\Zcar\Presenter;
...
class TopMenuPresenter extends Presenter
{
    ...
    {
        return '<li'.$this->getActiveState($item).' class="'.$item->attributes['class'].'"><a href="'.$item->getUrl().'" '.$item->getAttributes().'>'.$item->getIcon().' '.$item->title.'</a></li>'.PHP_EOL;
    }
