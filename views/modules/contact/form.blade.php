<div id="contact_form" class="mt-sm-30">
    ...
    <div class="row" data-gutter="10">
        <div class="col-md-6">
            <div class="form-group" :class="{'has-error':errors.first_name}">
                ...
                <span v-for="error in errors.first_name" class="form-text text-danger">@{{ error }}</span>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group" :class="{'has-error':errors.last_name}">
                ...
                <span v-for="error in errors.last_name" class="form-text text-danger">@{{ error }}</span>
            </div>
        </div>
    </div>
    ...
    <div class="row" data-gutter="10">
        <div class="col-md-6">
            <div class="form-group" :class="{'has-error':errors.phone}">
                ...
                <span v-for="error in errors.phone" class="form-text text-danger">@{{ error }}</span>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group" :class="{'has-error':errors.email}">
                ...
                <span v-for="error in errors.email" class="form-text text-danger">@{{ error }}</span>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group" :class="{'has-error':errors.enquiry}">
                <textarea name="enquiry" class="form-control" placeholder="{{ trans('contact::contacts.form.enquiry') }}" rows="5" v-model="input.enquiry" :class="{ 'is-invalid' : hasError('enquiry') }" style="height: 100px !important;"></textarea>
                <span v-for="error in errors.enquiry" class="form-text text-danger">@{{ error }}</span>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <span v-for="error in errors.captcha_contact" class="form-text text-danger">@{{ error }}</span>
            </div>
        </div>
        <div class="col-md-4">
