...
<div class="booking-item-payment mb20">
    <header class="clearfix">
        <a class="booking-item-payment-img mt15 text-theme-color" href="{{ $car->url }}">
            <img src="{{ $car->present()->firstImage(100,null,'resize',80) }}" alt="{{ $car->fullname }}" title="{{ $car->fullname }}" />
        </a>
        <h5 class="booking-item-payment-title mt5"><a class="text-theme-color" href="{{ $car->url }}">{!! $car->brand->present()->logo(40).' '.$car->fullname !!}</a></h5>
    ...
    <ul class="booking-item-payment-details">
        <li class="mb5">
            ...
            <a class="pull-right btn btn-light btn-sm" href="{{ $car->url }}"><i class="fa fa-calendar"></i> Tarih Değiştir</a>
        </li>
        <li>
