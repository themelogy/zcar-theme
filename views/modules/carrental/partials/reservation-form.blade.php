...
<div class="row">
    <div class="col-md-4">
        <div class="form-group{{ $errors->has("tc_no") ? ' has-error' : '' }}">
            ...
            {!! $errors->first("tc_no", '<span class="form-text text-danger">:message</span>') !!}
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group{{ $errors->has("first_name") ? ' has-error' : '' }}">
            ...
            {!! $errors->first("first_name", '<span class="form-text text-danger">:message</span>') !!}
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group{{ $errors->has("last_name") ? ' has-error' : '' }}">
            ...
            {!! $errors->first("last_name", '<span class="form-text text-danger">:message</span>') !!}
        </div>
    </div>
    <div class="col-md-4 m-top-10">
        <div class="form-group{{ $errors->has("phone") ? ' has-error' : '' }}">
            ...
            {!! $errors->first("phone", '<span class="form-text text-danger">:message</span>') !!}
        </div>
    </div>
    <div class="col-md-4 m-top-10">
        <div class="form-group{{ $errors->has("mobile_phone") ? ' has-error' : '' }}">
            ...
            {!! $errors->first("mobile_phone", '<span class="form-text text-danger">:message</span>') !!}
        </div>
    </div>
    <div class="col-md-4 m-top-10">
...
<div class="row">
    <div class="col-md-8">
        <div class="form-group mt10{{ $errors->has("g-recaptcha-response") ? ' has-error' : '' }}">
            {!! Captcha::display() !!}
            {!! $errors->first("g-recaptcha-response", '<span class="form-text text-danger">:message</span>') !!}
        </div>
    </div>
    <div class="col-md-4 text-right">
        {!! Form::submit(trans('themes::carrental.buttons.reservation'), ['class'=>'btn btn-sm btn-primary']) !!}
