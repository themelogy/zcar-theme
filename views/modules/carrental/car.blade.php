...
@section('header.title')
    @component('partials.components.title', ['breadcrumb'=>'carrental.car'])
        <h1>{{ trans('themes::carrental.titles.car', ['car'=>$car->fullname]) }}</h1>
    @endcomponent
@endsection

@section('content')
    <section class="r-car-showcase-wrapper section-car">
        <div class="container">
            <div class="booking-item-details">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <span class="badge badge-warning pull-right text-theme-color">{{ $car->carclass->name }}</span>
                        <div class="clearfix"></div>
                        <div class="fotorama" data-allowfullscreen="true" data-nav="thumbs">
                            @foreach($car->present()->images(800,null,'resize',80) as $image)
                                <a href="{{ $image }}"><img src="{{ $image }}" alt="{{ trans('themes::carrental.titles.car', ['car'=>$car->fullname]) }}" title="{{ trans('themes::carrental.titles.car', ['car'=>$car->fullname]) }}"/></a>
                            @endforeach
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="tabbable">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" href="#car-features" data-toggle="tab">Araç Özellikleri</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#car-details" data-toggle="tab">Açıklama</a></li>
                                    </ul>
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="car-features">
...
@push('css-stack')
    {!! Theme::style('vendor/fotorama/fotorama.css') !!}
@endpush

@push('js-stack')
    {!! Theme::script('vendor/fotorama/fotorama.js') !!}
@endpush
